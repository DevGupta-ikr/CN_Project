/**
This class represents the Second user of the Group Chatting Application.
*/
...
public class UserTwo implements ActionListener, Runnable 
{
    ...
    UserTwo() 
    {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/test.png"));
        ...
        JLabel name = new JLabel("CSE A 2020-2024");
        name.setBounds(110, 15, 100, 18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SAN_SERIF", Font.BOLD, 18));
        p1.add(name);
        
        JLabel status = new JLabel("Marry, Jack, John, Sam");
    ...
    {
        // Create an instance of UserTwo and start a new thread to run it
